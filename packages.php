...
class Package {
    ...
    public function __construct($id, $name, $type, $price, $duration, $description, $image) {
        $this->id = $id;
        $this->name = $name;
        $this->type = $type;
        $this->price = $price;
...
class Subscription {
    ...
    public function __construct($id, $user_id, $package_id, $start_date, $end_date, $status) {
        $this->id = $id;
...
class PackageManager {
    ...
    public function getAllPackages() {
        $query = "SELECT id, name, type, price, duration, description, image FROM packages";
        $stmt = $this->db->prepare($query);
        $stmt->execute();
        return $stmt->fetchAll(PDO::FETCH_ASSOC);
    }

    public function addPackage($name, $type, $price, $duration, $description, $image) {
        $query = "INSERT INTO packages (name, type, price, duration, description, image) VALUES (?, ?, ?, ?, ?, ?)";
        $stmt = $this->db->prepare($query);
        return $stmt->execute([$name, $type, $price, $duration, $description, $image]);
    }
}
...
class SubscriptionManager {
    ...
    public function addSubscription($user_id, $package_id, $start_date, $end_date) {
        $query = "INSERT INTO subscriptions (user_id, package_id, start_date, end_date, status) VALUES (?, ?, ?, ?, 'active')";
        $stmt = $this->db->prepare($query);
        return $stmt->execute([$user_id, $package_id, $start_date, $end_date]);
    }
...
<body>
    ...
    <div class="col-md-4">
        ...
        <div class="card-body">
                ...
                <p><strong>Type:</strong> <?php echo htmlspecialchars($package['type']); ?></p>
                ...
                <a href="subscribe.php?package_id=<?php echo $package['id']; ?>" class="btn btn-primary">Subscribe</a>
            </div>
        </div>
    </div>
<?php endforeach; ?>
