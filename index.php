                            ...
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    ...
                                    <div class="fruite-img">
                                        <img src="assets/img/fruite-item-5.jpg" class="img-fluid w-100 rounded-top" alt="Grapes">
                                    </div>
                                          ...
                                          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                           <div class="d-flex justify-content-between flex-lg-wrap">
                                              ...
                                              <a role="button" class="btn border border-secondary rounded-pill px-3 text-primary add-to-cart"
                                                  data-id="1" data-name="Grapes" data-price="4.99" data-image="assets/img/fruite-item-5.jpg">
                                            ...
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        <p class="text-dark fs-5 fw-bold mb-0">$4.99 / kg</p>
                                                        <a role="button" class="btn border border-secondary rounded-pill px-3 text-primary add-to-cart"
                                                           data-id="2" data-name="Raspberries" data-price="4.99" data-image="assets/img/fruite-item-2.jpg">
                                                           <i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        <p class="text-dark fs-5 fw-bold mb-0">$4.99 / kg</p>
                                                        <a role="button" class="btn border border-secondary rounded-pill px-3 text-primary add-to-cart"
                                                            data-id="3" data-name="Apricots" data-price="4.99" data-image="assets/img/fruite-item-4.jpg">
                                                            <i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        <p class="text-dark fs-5 fw-bold mb-0">$4.99 / kg</p>
                                                        <a role="button" class="btn border border-secondary rounded-pill px-3 text-primary add-to-cart"
                                                           data-id="4" data-name="Banana" data-price="4.99" data-image="assets/img/fruite-item-3.jpg">
                                                           <i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        <p class="text-dark fs-5 fw-bold mb-0">$4.99 / kg</p>
                                                        <a role="button" class="btn border border-secondary rounded-pill px-3 text-primary add-to-cart"
                                                            data-id="5" data-name="Oranges" data-price="4.99" data-image="assets/img/fruite-item-1.jpg">
                                                            <i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        <p class="text-dark fs-5 fw-bold mb-0">$4.99 / kg</p>
                                                        <a role="button" class="btn border border-secondary rounded-pill px-3 text-primary add-to-cart"
                                                            data-id="1" data-name="Grapes" data-price="4.99" data-image="img/fruite-item-5.jpg">
                                                            <i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        <p class="text-dark fs-5 fw-bold mb-0">$4.99 / kg</p>
                                                        <a role="button" class="btn border border-secondary rounded-pill px-3 text-primary add-to-cart"
                                                           data-id="6" data-name="Grapes" data-price="4.99" data-image="assets/img/fruite-item-6.jpg">
                                                           <i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart
                                                        </a>
                                                    </div>
                                                </div>
